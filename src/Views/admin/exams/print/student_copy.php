...
if (!function_exists('print_single_cell_value')) {
    function print_single_cell_value(mixed $value): string
    {
...
if (!function_exists('print_single_tampon_svg')) {
    function print_single_tampon_svg(): string
    {
...
<head>
    <meta charset="utf-8">
    <title>Impression copie élève</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 10mm;
        ...
        <?php else: ?>
            <?php foreach ($questions as $q): ?>
                <tr>
                    ...
                    <td><?= print_single_cell_value($q['question_text'] ?? '') ?></td>
                    <td><?= print_single_cell_value($q['student_answer'] ?? '') ?></td>
                    <td><?= print_single_cell_value($q['correct_answer'] ?? '') ?></td>
